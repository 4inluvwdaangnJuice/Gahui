...
국내 사용후 배터리 배출량 2025년 8,321개 → 2030년 107,500개 전망
...
수도권 양조장 기준 1일 8톤 이상 폐기. 주류 공장에서 상시 배출되어 수급 안정
...
③ 이후는 기존 습식 제련 표준 경로 활용. 

### 2-2. ① 압착 전처리

**원물 술지게미 → 분쇄 → 향류 2단 압착 → 미세 여과 → 정량 → 침출조 투입**

| 단계 | 조작 | 목적 |
|:---:|---|---|
| 1 | 분쇄 | 입자 균질화로 압착액 조성 편차 억제 |
| 2 | 향류 2단 압착 | 환원당 회수 |
| 3 | 2차 압착액 순환 | 1차 세척액으로 재사용 |
| 4 | 미세 고형분 여과 | 슬러리 점도 관리 |
| 5 | 환원당·에탄올 정량 | 배치별 투입 부피 산정 |
...
NCM811 전이금속 평균 산화수 +3 → 산 용해성 +2로 환원 시 화학식 단위당 전자 1 mol 필요

`e⁻ = 2c − a − 2b` (a: Li 계수, b: 전이금속 계수 합, c: O 계수)

| 구분 | 산출 | 값 |
|---|---|---:|
| 요구 전자량 | 1000 g ÷ 97.27 g/mol × 1 mol e⁻ | **10.28** mol e⁻/kg-CAM |
| 공급 전자량 | 51.22 g/L ÷ 180.16 × nₑ 2 × 50 L/kg | **28.43** mol e⁻/kg-CAM |
| 공급 여유 | 28.43 ÷ 10.28 | **2.8** 배 |
| 성립 하한 | 요구량 충족 최소 환원당 농도 | **18.5** g/L |

* **nₑ = 2** — 알데하이드기 → 카복실기 산화, 전자 2개 공여. `R–CHO + H₂O → R–COOH + 2H⁺ + 2e⁻`
* **에탄올 제외** — nₑ = 4로 공여력은 크나 끓는점 78 °C가 조업 온도에 근접. 기화 불확실성으로 수지에서 배제
* **의미** — 환원당 51.2 → 18.5 g/L, 즉 64 % 감소까지 요구량 충족.
...
식품의약품안전처는 2020년부터 주박이 음료 목적으로 사용되지 않는 경우 주세법상 주류에 비해당한다고 정리. 식품 외 용도 전환에 제약 없음
